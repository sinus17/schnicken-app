...
(0, server_ts_1.serve)(function (req) { return __awaiter(void 0, void 0, void 0, function () {
    var supabaseUrl, supabaseKey, supabase, _a, email, password, username, _b, data, error, _c, playerData, playerError, error_1;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 2:
                ...
                console.log('Edge function: Attempting to create user:', { email: email, username: username });
            ...
            case 3:
                ...
                if (error) {
                    ...
                    return [2 /*return*/, new Response(JSON.stringify({ error: { message: error.message, code: error.code } }), { status: 400, headers: __assign(__assign({}, corsHeaders), { 'Content-Type': 'application/json' }) })];
                }
                ...
                return [4 /*yield*/, supabase
                        ...
                        .select('id')];
            case 4:
                _c = _d.sent(), playerData = _c.data, playerError = _c.error;
                if (playerError) {
            ...
            case 5:
                ...
                _d.label = 6;
            case 6: return [2 /*return*/, new Response(JSON.stringify({ user: data.user }), { status: 200, headers: __assign(__assign({}, corsHeaders), { 'Content-Type': 'application/json' }) })];
            case 7:
                error_1 = _d.sent();
